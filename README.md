...
CMD RightArrow  →  Split Pane Right
CMD LeftArrow   →  Split Pane Left
CMD UpArrow     →  Split Pane Up
CMD DownArrow   →  Split Pane Down

CMD w           →  Close Current Pane
CMD SHIFT F     →  Toggle Zoom Current Pane
CMD [           →  Focus Prev Pane
CMD ]           →  Focus Next Pane
